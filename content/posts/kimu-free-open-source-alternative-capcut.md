...
categories: ["tools"]
description: "CapCut sold your data. Kimu won't. Here's a free, open-source video editor with an AI copilot that actually works — and you can run it on your own machine."
ShowToc: true
cover:
...
**GitHub:** [1,800+ stars](https://github.com/trykimu/videoeditor)
...
Go to [trykimu.com](https://trykimu.com), sign up, start editing. Free. No credit card.

**Option 2: Self-host (full control)**
```bash
git clone https://github.com/trykimu/videoeditor.git
cd videoeditor
docker compose up
```
...
| Feature | CapCut | Kimu |
|---------|--------|------|
| Price | Free tier + $7.99/mo Pro | Completely free |
| Watermarks | Yes (free tier) | No |
| AI features | Basic | AI copilot |
| Open-source | No | Yes |
| Self-hostable | No | Yes |
| Data collection | Yes (ByteDance) | None |
| Offline editing | Limited | Yes (self-hosted) |
...
*Kimu is free and open-source. Try it at [trykimu.com](https://trykimu.com) or self-host from [GitHub](https://github.com/trykimu/videoeditor).*
