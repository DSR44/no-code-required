...
categories: ["tools"]
slug: "general-intuition-2-billion-valuation-nerve-gamers"
keywords: ["General Intuition valuation 2026", "AI agents video game training", "Nerve platform gamers AI jobs", "General Intuition funding", "world models AI startups"]
ShowToc: true
TocOpen: false
cover:
  image: "/images/posts/general-intuition-2-billion-valuation-nerve-gamers.jpg"
  alt: "Zoe reading about General Intuition's funding news on her laptop"
---
{{< audio src="/audio/general-intuition-2-billion-valuation-nerve-gamers.mp3" >}}

I covered [General Intuition's initial $134M raise](/posts/general-intuition-ai-agents-video-game-data/) last month — the startup that trains AI agents using billions of video game clips from Medal's 10 million monthly users. At the time, the pitch was interesting but unproven. Now they've raised another $320 million at a $2.3 billion valuation, and the story has gotten a lot more concrete. They've got a working robot, a jobs platform for gamers, and Vinod Khosla calling it a "generational bet." Here's what actually changed.
...
The key insight: the same brain that learns to navigate a virtual world can transfer that understanding to the physical one. This is what [AI agents becoming employees](/posts/ai-agents-are-becoming-employees/) looks like in practice — not chatbots answering emails, but models that understand space, time, and cause-and-effect well enough to walk a robot through an office.
...
If you're building with AI tools — whether it's [automating your business](/posts/build-your-first-automation-in-15-minutes/) or [creating content with AI](/posts/heygen-avatar-v-vs-avatar-3/) — General Intuition's approach suggests the next wave of AI agents won't come from bigger language models. They'll come from models that understand the physical world.
...
For anyone watching the AI space, this is one to track. The API launch this summer will tell us a lot. If you want to stay on top of [what's actually working in AI tools](/posts/the-tools-i-actually-use-every-day/), I cover the developments that matter — not just the ones that make headlines. And if you're new to AI agents, [start here](/start-here/) — I break down the concepts without the jargon.
