...
(async () => {
  ...
  const staticPath = path.join(__dirname, '../../static/downloads/the-0-dollar-ai-starter-kit.pdf');
  ...
  fs.copyFileSync(pdfPath, staticPath);
  console.log('PDF created:', pdfPath);
  console.log('Copied to:', staticPath);
})();
